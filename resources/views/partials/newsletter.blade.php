<h2 class="dev-updates-title"><i class="fa fa-edit"></i> Subscribe to Development Updates</h2>
<div class="d-flex text-center subscribe-section">
    <form class="form-inline mx-auto" method="POST" action="{{ route('newsletter.subscribe') }}" role="form" name="{{ $formName }}" class="subscriber_form">
